...
class Section(Base):
    ...
    book_left_door_width = Column(Float, nullable=True)
    book_right_door_width = Column(Float, nullable=True)
    book_left_fixed_left_enabled = Column(Boolean, default=False)
    book_left_fixed_left_width = Column(Float, nullable=True)
    book_left_fixed_right_enabled = Column(Boolean, default=False)
    book_left_fixed_right_width = Column(Float, nullable=True)
    book_right_fixed_left_enabled = Column(Boolean, default=False)
    book_right_fixed_left_width = Column(Float, nullable=True)
    book_right_fixed_right_enabled = Column(Boolean, default=False)
    book_right_fixed_right_width = Column(Float, nullable=True)
